...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 1px 2px rgba(8, 24, 55, 0.05), 0 2px 8px rgba(8, 24, 55, 0.04)",
        medium: "0 6px 20px rgba(8, 24, 55, 0.09), 0 2px 6px rgba(8, 24, 55, 0.05)",
        large: "0 18px 42px rgba(8, 24, 55, 0.12), 0 4px 14px rgba(8, 24, 55, 0.08)",
        xl: "0 28px 56px rgba(8, 24, 55, 0.16), 0 8px 22px rgba(8, 24, 55, 0.1)",
        card: "0 4px 14px rgba(8, 24, 55, 0.07), 0 1px 3px rgba(8, 24, 55, 0.06)",
        "card-hover": "0 18px 36px rgba(8, 24, 55, 0.12), 0 4px 12px rgba(8, 24, 55, 0.08)",
        ring: "0 0 0 4px hsl(var(--primary) / 0.22)",

        glow: "0 18px 44px rgba(26, 126, 255, 0.24)",
        "card-legacy": "0 2px 8px rgba(8, 24, 55, 0.08)",
        lift: "0 24px 50px rgba(8, 24, 55, 0.14)",
      },
      spacing: {
        xs: "0.25rem",
        sm: "0.5rem",
